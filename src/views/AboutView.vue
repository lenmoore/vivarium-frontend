<template>
    <div class="container">
        ...
        <p>
            Vaevalt. Ent see ei tähenda, et me ei võiks täna teatris rakendada
            erinevaid tehnoloogilisi vahendeid. Eriti, kui nende abil on
            võimalik anda publikule lavastuses uusi rolle ja võimalusi.
            Rahvusvahelise teatriprojekti
            <a href="http://www.play-on.eu/">„PlayOn!”</a> raames
            kaardistataksegi teatri ja tehnoloogiate ühisvälja. Nelja aasta
            jooksul saavad projekti partnerid panna end proovile mitme erineva
            ebatavalise võtte või lähtepunktiga.
        </p>

        <p>
            VAT Teatri esmane plaan oli <strong>„Vivaariumis”</strong> katsetada
            <strong>motion- ja movement-trackingut</strong>. Koos
            projektipartneri Teatro O Bandoga asusimegi ühisele avastusretkele.
            Motion- ja movement-tracking aitab jälgida nii näitlejate kui
            publiku paiknemist, liikumist ja reaktsioone (teatri)ruumis.
            Tegemist on teatri mõttes äärmiselt põneva tehnoloogiaga ja
            loodetavasti jõuame tulevikus ka selle rakendamiseni.
        </p>
        <p>
            „Vivaariumiga” läks aga nõndaviisi, et mida rohkem teste me tegime,
            seda enam oli selge, et antud lavastuse puhul huvitavad meid publiku
            liikumisest rohkem publiku valikud. Seega pöördusime arendaja
            <strong>Helena Väinmaa</strong> poole, kes lõi lavastusele
            spetsiaalse ja mitmekülgse veebirakenduse, mille abil saab osaleja
            kulgeda läbi terve Vivaariumi loo.
        </p>

        <p>
            Projekti „PlayOn!” eesmärk on anda publikule teatris aktiivne roll
            ning mõtestada erinevaid ühiskondlikke tulevikustsenaariume. Mõlemad
            elemendid on „Vivaariumis” ka esindatud. Nende keskel paikneb aga
            meie loomingulise tiimi jaoks põletav teema –
            <strong>kajakambrid</strong>.
        </p>
        <p>
            Koroona-aastad tõestasid ilmekalt, kuidas oma kodudesse eraldunud
            inimesed jäid üha enam tehismaailma toimemehhanismide meelevalda.
            Veebi korrastavad algoritmid kannavad endas iseenesest õilsat
            eesmärki: nad püüavad tohutu infovälja sees leida üles need
            ...
            tunneb mind juba paremini kui ma ise.
        </p>
        ...
        <p>
            ...
            äärmuses. Hea, kui minu Youtube´i on vallutanud kassivideod; halb
            aga, kui samasugune radikaliseerumine on toimunud maailmavaates. Ja
            kahjuks on algoritmid suutelised sellekski. Rääkimata siis veel
            meediamajadest, poliitikutest, ühiskondliku arvamuse
            kujundajatest...
        </p>

        <p>
            Öeldaks, et teater võiks olla veel viimane koht, kuhu põgeneda
            ekraanide ja säutsude eest. Öeldakse, et mobiili vahtimise vajadus
            on juba ületanud traditsioonilised sõltuvused.
            <br />
            „Vivaariumis” ei tohtinud sa oma mobiili välja lülitada. Kui
            hääletamine ja virtuaalne ostlemine kõrvale jätta, siis mitu korda
            sa oma mobiili etenduse jooksul vaatasid? Ootamatult vähe? Võib-olla
            on tõesti nii, et kui anda taskutelefonile kunstikogemuses
            konkreetne roll, siis muutub probleem äkki hoopis lahenduseks?
        </p>
